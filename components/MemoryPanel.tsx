      ...
      <div className="shrink-0 h-[20%] min-h-[120px] border-t border-gray-700 bg-blue-900/5 flex flex-col">
            <div className="px-3 py-2 border-b border-blue-900/20 bg-blue-900/10 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-[11px] font-bold uppercase tracking-wider text-blue-300">Inference Stream</span>
                </div>
                <span className="text-[10px] text-blue-500 font-mono">{proposedItems.length} New</span>
            </div>
                    ...
                    <ul className="space-y-2">
                        {proposedItems.map(item => (
                            <li key={item.id}>
                                <button 
                                    onClick={() => onEdit(item)}
                                    className="w-full text-left p-2 bg-gray-800 border border-blue-500/20 rounded text-[11px] text-blue-200 hover:border-blue-400/50 transition-all line-clamp-2 leading-tight"
                                >
                                    {item.content}
                                </button>
                            </li>
