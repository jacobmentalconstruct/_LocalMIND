...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M6.343 12.343 8.5 11.5" />
    <path d="M17.657 12.343 15.5 11.5" />
    <path d="m12.343 17.657-1.843-.843" />
    <path d="m12.343 6.343-1.843.843" />
    <path d="m6.343 11.657.843-1.843" />
    <path d="M17.657 11.657 16.814 13.5" />
  </svg>
);
...
export const PowerOffIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
